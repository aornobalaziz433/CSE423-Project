...
def update_game_state():
    global car_pos, car_speed, LIVES, game_over, last_spawn_check, SCORE, COIN_COUNT
    ...
    for z in zombies:
        ...
        dx = car_pos[0] - z['pos'][0]
        dy = car_pos[1] - z['pos'][1]
...
def main():
    ...
    glutCreateWindow(b"Doomsday Journey - Navigation Map")
